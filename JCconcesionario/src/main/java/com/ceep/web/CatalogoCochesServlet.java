 ...
 * @author PC
 */
@WebServlet(name = "CatalogoCochesServlet", urlPatterns = {"/CatalogoCochesServlet"})
public class CatalogoCochesServlet extends HttpServlet {
    ...
    List<Coches> coches=cochesService.findAllCochesSinVender();
